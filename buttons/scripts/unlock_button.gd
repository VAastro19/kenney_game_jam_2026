...
var building_type: BuildManager.BuildingType = BuildManager.BuildingType.NONE
var generator_type: EconomyManager.CoinType = EconomyManager.CoinType.NONE
...
func _ready() -> void:
	...
	match unlock:
		Unlock.LUMBER:
			...
			building_type = BuildManager.BuildingType.LUMBER
			is_bulding = true
		...
		Unlock.BLACKSMITH:
			...
			cost_label.text = "[font_size=28][outline_size=4]Cost: " + str(int(cost)) + " [img=18]res://assets/graphics/coins/" + cost_type_name + "_coin.png[/img]"
			building_type = BuildManager.BuildingType.BLACKSMITH
			is_bulding = true
		...
		Unlock.CASTLE:
			...
			cost_label.text = "[font_size=28][outline_size=4]Cost: " + str(int(cost)) + " [img=18]res://assets/graphics/coins/" + cost_type_name + "_coin.png[/img]"
			building_type = BuildManager.BuildingType.CASTLE
			is_bulding = true
		...
		Unlock.GREEN_GEN:
			...
			cost_label.text = "[font_size=28][outline_size=4]Cost: " + str(int(cost)) + " [img=18]res://assets/graphics/coins/" + cost_type_name + "_coin.png[/img]"
			generator_type = EconomyManager.CoinType.GREEN
			is_bulding = false
		...
		Unlock.YELLOW_GEN:
			...
			cost_label.text = "[font_size=28][outline_size=4]Cost: " + str(int(cost)) + " [img=18]res://assets/graphics/coins/" + cost_type_name + "_coin.png[/img]"
			generator_type = EconomyManager.CoinType.YELLOW
			is_bulding = false
		...
		Unlock.RED_GEN:
			...
			cost_label.text = "[font_size=28][outline_size=4]Cost: " + str(int(cost)) + " [img=18]res://assets/graphics/coins/" + cost_type_name + "_coin.png[/img]"
			generator_type = EconomyManager.CoinType.RED
			is_bulding = false
